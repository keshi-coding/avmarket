...
def detalhes_comunidade(request, group_id):
    ...
    return render(request, 'av_app/detalhes_comunidade.html', {
...
def comunidades(request):
    ...
    return render(request, 'av_app/comunidades.html', {'comunidades': comunidades})
...
def home(request):
    ...
    """
    return render(request, 'av_app/home.html', {'username': request.user.username})
...
def perfil(request, email=None):
    ...
    return render(request, 'av_app/perfil.html', {
...
def editar_perfil(request):
    ...
    return render(request, 'av_app/editar_perfil.html', {'form': form})
...
def tela_inicial(request):
    ...
    return render(request, 'av_app/tela_inicial.html')
...
def lista_mensagens(request):
    ...
    return render(request, 'av_app/lista_mensagens.html', {
...
def listar_usuarios(request):
    ...
    return render(request, 'av_app/listar_usuarios.html', {'usuarios': usuarios})
...
def enviar_mensagem(request, email):
    ...
    return render(request, 'av_app/enviar_mensagem.html', {'destinatario': destinatario})
...
from av_app.views import home, perfil, editar_perfil, tela_inicial, verificar_email, lista_mensagens, listar_usuarios, \
    enviar_mensagem, resend_verification_email, comunidades, entrar_comunidade, detalhes_comunidade

# Importa as views específicas do app 'av_app'
urlpatterns = [
...
STATICFILES_DIRS = [
    BASE_DIR / 'av_app/static',  # Configura a pasta estática do app
]
...
```python
"""
ASGI config for av_project project.
...
## av_app/templates/av_app/base.html
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{% url 'lista_mensagens' %}"
                  >Mensagens</a
                >
                <!-- Link para mensagens -->
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="{% url 'comunidades' %}"
                  >Comunidades</a
                >
              </li>
              <li class="nav-item">
...
## av_app/templates/av_app/perfil.html

```html
{% extends "av_app/base.html" %} {% block title %}Perfil do Usuário{% endblock
%} {% block content %}
<div class="container mt-5">
  ...
  <div class="card mx-auto" style="max-width: 800px;">
    <div class="card-body">
      ...
      <p>
        <strong>Idade:</strong> {{ profile.age|default_if_none:"Não informado"
        }}
      </p>
      <p>
        <strong>Localização:</strong> {{ profile.city|default_if_none:"Não
        informado" }}, {{ profile.state|default_if_none:"" }} {{
        profile.country|default_if_none:"" }}
      </p>
      <p>
        <strong>Estado Civil:</strong> {{
        profile.marital_status|default_if_none:"Não informado" }}
      </p>

      <!-- Estilo de Vida -->
      <h5 class="card-title mt-4">Estilo de Vida</h5>
      <p>
        <strong>Religião:</strong> {{ profile.religion|default_if_none:"Não
        informado" }}
      </p>
      <p>
        <strong>Idiomas:</strong> {{ profile.languages|default_if_none:"Não
        informado" }}
      </p>
      <p>
        <strong>Fumante:</strong> {{ profile.smoking_status|default_if_none:"Não
        informado" }}
      </p>
      <p>
        <strong>Bebe álcool:</strong> {{
        profile.drinking_status|default_if_none:"Não informado" }}
      </p>
      <p>
        <strong>Estilo caseiro:</strong>
        {% if profile.more_homebody %} Mais caseiro {% elif
        profile.less_homebody %} Menos caseiro {% else %} Não informado {% endif
        %}
      </p>
      ...
      <p>
        <strong>Altura:</strong> {{ profile.height|default_if_none:"Não
        informado" }} cm
      </p>
      <p>
        <strong>Peso:</strong> {{ profile.weight|default_if_none:"Não informado"
        }} kg
      </p>
      <p>
        <strong>Tipo físico:</strong> {{ profile.body_type|default_if_none:"Não
        informado" }}
      </p>
      ...
      <p>
        <strong>Se assume como LGBTQ+:</strong> {{
        profile.lgbtq_status|default_if_none:"Não informado" }}
      </p>
      <p>
        <strong>Papel em Relacionamentos:</strong> {{
        profile.relationship_role|default_if_none:"Não informado" }}
      </p>
      <p>
        <strong>Descrição do Papel:</strong> {{
        profile.role_description|default_if_none:"Não informado" }}
      </p>
      <p>
        <strong>Procurando por:</strong> {{
        profile.looking_for|default_if_none:"Não informado" }}
      </p>
      <p>
        <strong>Frase de Destaque:</strong> "{{
        profile.headline|default_if_none:"Nenhuma frase definida" }}"
      </p>
    </div>
    ...
    <div class="card-footer text-center">
      ...
      <a href="{% url 'enviar_mensagem' email %}" class="btn btn-primary mt-3"
        >Enviar Mensagem</a
      >
      {% endif %}
    </div>
...
## 2.3 av_app/templates/av_app/tela_inicial.html
...
<html lang="pt-br">
  ...
  <body>
    {% block content %} {% url 'account_signup' as signup_url %}
...
## av_app/templates/av_app/listar_usuarios.html

```html
{% extends 'av_app/base.html' %} {% block content %}
  ...
  <div class="col-md-4 mb-4">
    <div class="user-card">
      ...
      <img
        ...
        class="img-thumbnail"
        alt="Foto de {{ usuario.user.username }}"
      />
      {% else %}
      <img
      ...
      <div class="user-details">
        ...
        <a
          href="{% url 'perfil_outro' usuario.user.email %}"
...
## av_app/templates/av_app/home.html
...
## av_app/templates/av_app/editar_perfil.html

```html
{% extends "av_app/base.html" %} {% block title %}Editar Perfil{% endblock %} {%
block content %}
<div class="container mt-5">
...
{{ form.interests.value }}</textarea
        ...
        <div class="mb-3">
          ...
          <input
            ...
            name="smoking_status"
            class="form-control"
            value="{{ form.smoking_status.value }}"
          />
        </div>
        ...
        <div class="mb-3">
          ...
          <input
            ...
            class="form-control"
            value="{{ form.drinking_status.value }}"
          />
        </div>
        ...
        <div class="mb-3 text-center">
          ...
          <!-- A label será renderizada automaticamente -->
        ...
        <div class="mb-3">
          ...
          <input
            ...
            class="form-control"
            value="{{ form.relationship_role.value }}"
          />
        </div>
...
{{ form.role_description.value }}</textarea
          >
        </div>
...
## av_app/templates/account/signup.html

```html
{% extends "av_app/base.html" %} {% block title %}Cadastre-se{% endblock %} {%
block content %}
<div class="container text-center mt-5">
  <h1>Crie sua Conta</h1>
  <p class="lead mt-3">
    Já tem uma conta? <a href="{% url 'tela_inicial' %}">Faça login aqui</a>.
  </p>
  ...
  <div class="mt-4">
    ...
    >
      ...
      <div
        ...
        style="background-color: #f0f8ff; color: #004085; border-color: #cce5ff;"
      >
        <strong>Atenção:</strong> Após preencher seu e-mail, você precisará
        digitá-lo novamente para confirmação. Enviaremos um e-mail para validar
        sua conta. Certifique-se de digitar corretamente!
      </div>
      ...
      <div class="mb-3">
        <label for="id_confirm_email" class="form-label"
          >Confirme seu E-mail</label
        >
        <input
          type="email"
          id="id_confirm_email"
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const emailFeedback = document.querySelector("#email_feedback");
    const confirmEmailFeedback = document.querySelector(
      "#confirm_email_feedback"
    );
...
## av_app/templates/account/verification_sent.html

```html
{% extends "av_app/base.html" %} {% block title %}E-mail de Confirmação
Enviado{% endblock %} {% block content %}
<html lang="pt-br">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="container text-center mt-5">
      ...
      <p class="lead mt-3">
        Um e-mail de confirmação foi enviado para o endereço cadastrado. Siga as
        instruções no e-mail para finalizar o cadastro.
      </p>

      <!-- Instrução adicional para o caso de o e-mail não ser encontrado -->
      <p>
        Caso não encontre o e-mail na sua caixa de entrada, verifique a pasta de
        spam ou lixeira.
      </p>
      ...
      <p class="mt-4">
        ...
        <a href="{% url 'account_resend_email' %}" class="btn btn-link"
...
## av_app/templates/account/password_reset.html
  ...
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card shadow">
        ...
        <div class="card-body">
          <p class="text-center">
            Esqueceu sua senha? Insira seu e-mail abaixo e enviaremos um link
            para redefini-la.
          </p>
          <form method="post">
            {% csrf_token %}
...
## av_app/templates/account/comunidades.html

```html
{% e{% extends "av_app/base.html" %} {% block title %}Comunidades{% endblock %}
{% block content %}
<div class="container mt-5">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <button class="btn btn-success" disabled>
            Você já está nessa comunidade
          </button>
          {% else %}
          <form
            method="post"
            action="{% url 'entrar_comunidade' comunidade.id %}"
          >
            {% csrf_token %}
            <button type="submit" class="btn btn-primary">Entrar</button>
            <a
              href="{% url 'detalhes_comunidade' comunidade.id %}"
...
## av_app/templates/account/detalhes_comunidade.html

```html
{% extends "av_app/base.html" %} {% block title %}{{ comunidade.name }}{%
